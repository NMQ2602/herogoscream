...
{
    public string achievementKey;   // Tên gợi nhớ để bạn gọi trong code (vd: "score_10")
    public string achievementID;    // ID thật từ Google Console (vd: "CgkIu9...")
    public bool isIncremental;      // Tick nếu là thành tích cộng dồn (vd: thắng 10 trận)
}